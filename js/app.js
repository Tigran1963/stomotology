(() => {
    ...
    function dataMediaQueries(array, dataSetValue) {
        ...
        if (media.length) {
            ...
            media.forEach((item => {
                ...
                if (item.hasAttribute("data-em")) breakpoint.dataEm = true;
            ...
            let mdQueries = breakpointsArray.map((function(item) {
                ...
                } else return "(" + item.type + "-width: " + item.value + "px)," + item.value + "," + item.type;
            }));
    ...
    function initSliders() {
        if (document.querySelector(".main-service__slider")) new core(".main-service__slider", {
            modules: [ Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".service-cases__slider")) new core(".service-cases__slider", {
            modules: [ Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 2,
        ...
        if (document.querySelector(".service-cases-images__slider")) new core(".service-cases-images__slider", {
            modules: [ Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".ratings__slider")) new core(".ratings__slider", {
            modules: [ Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 5,
        ...
        if (document.querySelector(".service-about-picture__slider")) new core(".service-about-picture__slider", {
            modules: [ Pagination ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
    ...
    DynamicAdapt.prototype.init = function() {
        ...
        for (let i = 0; i < this.nodes.length; i++) {
            ...
            if (node.hasAttribute("data-da-em")) оbject.dataEm = true;
        ...
        this.mediaQueries = Array.prototype.map.call(this.оbjects, (function(item) {
            if (item.dataEm) {
                item.breakpoint = (item.breakpoint / 16).toString();
                return "(" + this.type + "-width: " + item.breakpoint + "em)," + item.breakpoint;
            } else return "(" + this.type + "-width: " + item.breakpoint + "px)," + item.breakpoint;
        }), this);
    ...
    (function() {
        let speed = 2;
        let scroll = document.querySelector(".tabs__navigation_2");
        let left = 0;
        let drag = false;
        let coorX = 0;
        ...
        scroll.addEventListener("mousemove", (function(e) {
            if (drag) this.scrollLeft = left + (e.pageX - this.offsetLeft - coorX) * speed;
        }));
    })();
    (function() {
        let speed = 2;
        let scroll = document.querySelector(".tabs__navigation_1");
        let left = 0;
        let drag = false;
        let coorX = 0;
        scroll.addEventListener("mousedown", (function(e) {
    ...
    let readMoreBlocks = document.querySelectorAll(".read-more-block");
    let readMoreBtn = document.createElement("div");
    readMoreBtn.className = "read-more-btn";
    readMoreBtn.textContent = "Читать далее";
    readMoreBlocks.forEach((block => {
        if (block.clientHeight > 500) {
            block.classList.add("hidden");
            block.insertAdjacentHTML("beforeend", '<div class="read-more-btn">Читать далее</div>');
        }
    }));
